...
for i=2:numFrames
    ...
    for k=1:len
        ...
        % Taking both HOG and LBP feature
        ...
        if predClass ==1
            ...
            featurebike = [featLBP1 featHOG1];
            
            load Model_SVM_helmet.mat
            
            predClass1 = svmclassify(svmModel,featurebike)
            
            if predClass1 ==1
                disp('Bike with helmet')
                label = 'Bike with helmet';
            else
                disp('Bike without helmet')
                label = 'Bike with No helmet';
            end
...
%     figure(3),imshow(I2),title('Object detection');
   figure(4),imshow(f2),title('Helmet Recognition');
